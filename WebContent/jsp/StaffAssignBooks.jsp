...
<html>
	...
	<div class = "header">
		...
		<link rel = "stylesheet" href = "/LibrarySystem/css/StaffAssignBooks.css">   
	</head>
	<body>
		<form method =  "POST" action = "/LibrarySystem/StaffAssignBooksServlet" name = "StaffAssignBooksForm" >	
			<div class = "Table">
				<table class = "AssigningBooks">
					<tr>
					...
					<tr>
						<td><label for = "Label"> Pick Book to Add: </label> </td>
					...
					<tr>
						<td><label for = "ExpiryDate"> Choose Expiry Date: </label> </td>
					...
					<input type = "submit" value = "Assign Book" class = "button"></td>
					<div class = "SuccessfulorUnsuccessfulAssigning">
						<p>${ErrorMessage1}</p>
						<p>${ErrorMessage2}</p>
					</div>
			</div>
